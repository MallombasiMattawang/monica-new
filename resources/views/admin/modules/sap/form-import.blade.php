<div class="col-md-6">
    <div class="box box-primary">
        ...
        @endif
        <form role="form" action="{{url('ped-panel/submit-import-sap')}}" method="POST" enctype="multipart/form-data" onsubmit="disableSubmitButton()">
            @csrf
            <div class="box-body">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <ol>
                ...
                <li>Memastikan Tabel SAP yang akan di Import adalah data terbaru</li>
