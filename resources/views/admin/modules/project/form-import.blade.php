<div class="col-md-6">
    <div class="box box-primary">
        ...
        @endif
        <form role="form" action="{{url('ped-panel/submit-import-project')}}" method="POST" enctype="multipart/form-data" onsubmit="disableSubmitButton()">
            @csrf
            <div class="box-body">
        ...
        <div class="box-body">
            ...
            <ol>
                ...
                <li>Proses import data akan gagal jika terjadi hal berikut ini :
                    <ol>
                        <li>Sudah ada Porject dengan LOP Site ID di database</li>
