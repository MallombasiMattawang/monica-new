                                                ...
                                                ->where('actual_finish', '<>', '')
                                                    ...
                                                    ->where('actual_finish', '<>', '')
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $d->{'kendala'} }}</td>
                                                            <td>
                                                                {{ isset($tgl_mos->actual_finish) ? tgl_indo($tgl_mos->actual_finish) : '-' }}
                                                            </td>
                                                            <td>
                                                                {{ isset($tgl_install_done->actual_finish) ? tgl_indo($tgl_install_done->actual_finish) : '-' }}
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                {{ isset($tgl_install_done->actual_finish) ? selisih_hari($tgl_mos->actual_finish, $tgl_install_done->actual_finish) : '-' }}
                                                            </td>
                                                            <td>
