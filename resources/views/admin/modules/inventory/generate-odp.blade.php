                        ...
                        <tr>
                            ...
                            {{-- <td>
                                <select class="form-control" style="width: 100%;" name="status_go_live[]"
                                    ...
                                    <option value="VALIDASI ABD" {{ $d->status_go_live == 'VALIDASI ABD' ? 'SELECTED' : '' }}>VALIDASI ABD</option>
                                    <option value="DRAWING" {{ $d->status_go_live == 'DRAWING' ? 'SELECTED' : '' }}>DRAWING</option>
                                    <option value="INVENTORY" {{ $d->status_go_live == 'INVENTORY' ? 'SELECTED' : '' }}>INVENTORY</option>
                                    <option value="TERMINASI UIM" {{ $d->status_go_live == 'TERMINASI UIM' ? 'SELECTED' : '' }}>TERMINASI UIM</option>
                                    <option value="GOLIVE" {{ $d->status_go_live == 'GOLIVE' ? 'SELECTED' : '' }}>GOLIVE</option>
                                </select>
                            </td>
                            <td>
                                <select class="form-control" style="width: 100%;" name="kendala[]">
                                    <option value=""></option>
                                    <option value="Need Port OLT" {{ $d->kendala == 'Need Port OLT' ? 'SELECTED' : '' }}>Need Port OLT</option>
                                    <option value="Need Mini OLT" {{ $d->kendala == 'Need Mini OLT' ? 'SELECTED' : '' }}>Need Mini OLT</option>
                                    <option value="Core Feeder Unspec" {{ $d->kendala == 'Core Feeder Unspec' ? 'SELECTED' : '' }}>Core Feeder Unspec</option>
                                    <option value="Core Feeder Habis" {{ $d->kendala == 'Core Feeder Habis' ? 'SELECTED' : '' }}>Core Feeder Habis</option>
                                    <option value="Mancore Not Valid" {{ $d->kendala == 'Mancore Not Valid' ? 'SELECTED' : '' }}>Mancore Not Valid</option>
                                    <option value="Belum CT" {{ $d->kendala == 'Belum CT' ? 'SELECTED' : '' }}>Belum CT</option>
                                    <option value="Belum Valins" {{ $d->kendala == 'Belum Valins' ? 'SELECTED' : '' }}>Belum Valins</option>
                                </select>
                            </td>
                            <td>
                                <select class="form-control" style="width: 100%;" name="status_abd[]"
                                    data-value="NO ABD">
                                    <option value=""></option>
                                    <option value="NO ABD" {{ $d->status_abd == 'NO ABD' ? 'SELECTED' : '' }}>NO ABD</option>
                                    <option value="TIDAK VALID" {{ $d->status_abd == 'TIDAK VALID' ? 'SELECTED' : '' }}>TIDAK VALID</option>
            ...
            <div class="box-body" style="height: 500px; overflow-y: scroll;">
                <table class="table table-striped">
                    <tr>
                        ...
                        <td>
                            <select class="form-control" style="width: 100%;" name="status_gl_sdi"
                                data-value="NO DATA">
                                <option value="NO DATA" {{ $supervisi->status_gl_sdi == 'NO DATA' ? 'SELECTED' : '' }}>NO DATA</option>
                                <option value="VALIDASI ABD" {{ $supervisi->status_gl_sdi == 'VALIDASI ABD' ? 'SELECTED' : '' }}>VALIDASI ABD</option>
                                <option value="DRAWING" {{ $supervisi->status_gl_sdi == 'DRAWING' ? 'SELECTED' : '' }}>DRAWING</option>
                                <option value="INVENTORY" {{ $supervisi->status_gl_sdi == 'INVENTORY' ? 'SELECTED' : '' }}>INVENTORY</option>
                                <option value="TERMINASI UIM" {{ $supervisi->status_gl_sdi == 'TERMINASI UIM' ? 'SELECTED' : '' }}>TERMINASI UIM</option>
                                <option value="GOLIVE" {{ $supervisi->status_gl_sdi == 'GOLIVE' ? 'SELECTED' : '' }}>GOLIVE</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="ket_gl_sdi" value="{{ $supervisi->ket_gl_sdi }}">
                        </td>
                    </tr>
                    <tr>
                        <td>STATUS ABD </td>
                        <td>
                            <select class="form-control" style="width: 100%;" name="status_abd"
                                data-value="NO ABD">
                                <option value="NO ABD" {{ $supervisi->status_abd == 'NO ABD' ? 'SELECTED' : '' }}>NO ABD</option>
                    ...
                    <tr>
                        <td>ID SW</td>
                        <td>
                            <input type="text" class="form-control" name="id_sw" value="{{ $supervisi->id_sw }}" >
                        </td>
                    </tr>
                    <tr>
                        <td>ID IMON</td>
                        <td>
                            <input type="text" class="form-control" name="id_imon" value="{{ $supervisi->id_imon }}">
                        </td>
                    </tr>
                    <tr>
                        <td>PLAN GOLIVE</td>
