...
@section('contents')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="table-responsive">
                                                        <table class="table-sm table  table-hover ">
                                                            <tr>
                                                                <td width="30%" class="text-muted">Telepon </td>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted">ID Bank</td>
                                                                <td>{{ $profil->bank }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted">No Rekening Bank</td>
                                                                <td>{{ $profil->bank_no_rek }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted">Atas Nama Bank</td>
                                                                <td>{{ $profil->bank_an }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted">Latitude, Longitude</td>
                                                                <td>{{ $profil->lat }} , {{ $profil->lon }} </td>
                                                            </tr>
    ...
    @push('scripts')
        ...
        <script type="text/javascript"
            src="https://maps.google.com/maps/api/js?key=AIzaSyDsiwLbEcjMOzXceMQ7-vJh21icjaHmlJE&libraries=places"></script>
        <script>
