 ...
 <div class="body-header sticky-md-top">
     <div class="container-fluid">
         <div class="d-flex justify-content-between">
             <!-- Header:: Brand icon -->
             <a class="navbar-brand d-flex align-items-center color-900" href="{{ url('/dashboard') }}">
                         ...
                         <div class="dropdown-menu shadow-lg border-0 p-0 notifications" id="notifications">
                             <div class="card">
                                 <div class="card-header">
                                     ...
                                     <span class="badge bg-primary">{{ countNotifWaspang(getUser()->id) }}</span>
                                 </div>
                                 <ul class="list-unstyled list-group list-group-custom mb-0 custom_scroll" style="height: 320px;">
                                     @forelse (getNotifWaspang(getUser()->id) as $n)
                                     <li class="list-group-item d-flex border-end-0 border-start-0">
                                         <div class="avatar"><i class="fa fa-info fa-lg"></i></div>
                                         <div class="flex-grow-1 ms-2">
                                             <h6 class="mb-0 fw-light"><a href="{{ route('supervisi.detail', [$n->id, Str::slug($n->project_name)]) }}">{{ $n->project_name }}</a> </h6>
                                             <small>Update: {{ tgl_indo($n->updated_at) }}</small>
                                         </div>
                                     </li>
                                     @empty
                                 ...
                                 <div class="card-body py-2">
                                     <a href="{{ route('supervisi.index') }}" class="btn btn-link">View all notifications</a>
                                 </div>
                             </div>
                         </div>
                     </div>
